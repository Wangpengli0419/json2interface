...
var rootFlags;
(function (rootFlags) {
    rootFlags["declare"] = "declare";
    rootFlags["normal"] = "normal";
    rootFlags["export"] = "export";
})(rootFlags || (rootFlags = {}));
var Json2Ts = /** @class */ (function () {
    function Json2Ts() {
    }
    Json2Ts.prototype.convert = function (content, name, isexport) {
        if (name === void 0) { name = 'InterFace'; }
        if (isexport === void 0) { isexport = ''; }
    ...
    Json2Ts.prototype.formatCharsToTypeScript = function (jsonContent, objectName, optionalKeys) {
        ...
        return this._isexport == rootFlags.normal ? "interface  " + objectName + "  " + result : this._isexport + " interface  " + objectName + "  " + result;
    };
